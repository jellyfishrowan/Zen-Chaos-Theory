...
{// ---------- Learning Resources ----------
    ...
    {// ---------- Variable Declaration ----------
        ...
        preload = () => {
            ...
            backgroundImg = loadImage("https://picsum.photos/" + w + "/" + h);// backgroundImg.resize(10, 10);
        }
    }
    ...
    {// ---------- Define Actions and dependancies ----------
        setup = () => {
            ...
            layer = createGraphics(windowWidth, windowHeight);background(255);layer.fill("red");layer.strokeWeight(0);//top layer bounding box
        ...
        function mouseDragged() {
            ...
            for (var x = mouseX - eraserRadius; x < mouseX+eraserRadius; x++) {
                for (var y = mouseY - eraserRadius; y < mouseY+eraserRadius; y++) {
                    if ((dist(x,y, mouseX, mouseY) < eraserRadius) && x > 0 && x <= windowWidth) {// if mouse is greater than width, it will erase the modulus of width, (width: 50, mouse position: 107, affected pixel: 7). 
